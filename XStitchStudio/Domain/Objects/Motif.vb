...
Namespace Domain.Objects
    Public Class Motif
        ...
        Public Sub New()
            ...
            _columns = 0
        End Sub
        Public Sub New(pMotifId As Integer, pBlockStitches As List(Of BlockStitch), pBackStitches As List(Of BackStitch), pKnots As List(Of Knot), pRows As Integer, pColumns As Integer)
            _motifId = pMotifId
        ...
        Public Overrides Function ToString() As String
            ...
            _sb.Append("Motif=[") _
            .Append("MotifId=[").Append(CStr(_motifId)).Append("], ") _
        ...
        Public Function ToSaveString() As String
            Dim _sb As New StringBuilder
            _sb _
        .Append(MOTIF_HDR).Append(DESIGN_DELIM) _
        .Append(CStr(_motifId)).Append(DESIGN_DELIM) _
